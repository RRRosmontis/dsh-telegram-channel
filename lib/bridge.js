...
export class TelegramBridge {
    ...
    start() {
        ...
        this.disposeUserQuestionHook = this.ctx.on('user-questions/request', (req, next) => this.onUserQuestionRequest(req, next));
     ...
     * 于是 race 完全跟随 next()。
     */
    onUserQuestionRequest(req, next) {
